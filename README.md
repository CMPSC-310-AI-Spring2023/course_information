...
9 | March 13-17 | Project 2 work | <ul> <li> Lab 2 DUE.</li> <li> [Read Section 2.3: Linear Algebra](https://d2l.ai/chapter_preliminaries/linear-algebra.htmll)</li> <li>Challenge Problem 5. </li></ul> |
10 | March 20-24 | [Neural Networks](https://github.com/CMPSC-310-AI-Spring2023/course_information/blob/main/slides/9.NN.pdf). | <ul><li>[Activity 12](https://classroom.github.com/a/cZF9Du5c).</li> <li>Challenge Problem 5.</li> <li>Project 3 Released.</li></ul> |
