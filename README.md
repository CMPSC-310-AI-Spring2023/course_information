...
10 | March 20-24 | [Neural Networks](https://github.com/CMPSC-310-AI-Spring2023/course_information/blob/main/slides/10.NN.pdf). | <ul><li>[Activity 12: Neural Network](https://classroom.github.com/a/cZF9Du5c).</li> <li>[Activity 13: TensorFlow](https://forms.gle/EMz1jxf82Rfd8AYs7)</li><li>Challenge Problem 5.</li> <li>Project 3 Released.</li> <li> [Read Section 2.3: Linear Algebra](https://d2l.ai/chapter_preliminaries/linear-algebra.htmll)</li></ul> |
